<?php get_header(); ?>
  ...
  <section class="guide inner marginTop-100-48">
    <h1 class="guide__title pageTitle"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/common/beginner.png'); ?>" alt="初心者のアイコンマーク" />初めてP-JOB for バイトをお使いになる方へ</h1>
    <p class="guide__lead">地元で見つかる理想のパート・アルバイト！<br>P-JOB for バイトでは、地元企業が提供するパート・アルバイトのお仕事を豊富に取り扱っています。あなたのライフスタイルに合わせて、短時間勤務やシフト制のお仕事も多数！<br class="u-mobile">「家事の合間に働きたい」「学校と両立して働きたい」そんなあなたの希望を叶える仕事がきっと見つかります。</p>
    <div class="guide__items">
      <div class="guide__item">
        ...
        <p class="guide__item-description">P-JOB for バイトでは、取り扱う求人を北関東（栃木、茨城、群馬、埼玉）に限定しています。<br>北関東でお仕事を探したい方に向けて、エリアごとのソート機能や、レコメンド機能も充実！<br class="u-desktop">あなたにぴったりのお仕事がきっと見つかります。</p>
      </div>
      <div class="guide__item">
        <div class="guide__item-heading guideItemHeading">
          <span class="guideItemHeading__pointCircle pointCircle">
        ...
        <p class="guide__item-description">P-JOB for バイトを運用している株式会社プラスワークでは、20年にわたって人材総合サービス会社を運営しています。長年蓄積された実績やノウハウを熟知した人材のプロが集結し、求人情報を丁寧に選定しているので、優良な求人情報が揃っています。</p>
      </div>
      <div class="guide__item">
        <div class="guide__item-heading guideItemHeading">
          <span class="guideItemHeading__pointCircle pointCircle">
        ...
        <p class="guide__item-description">P-JOB for バイトは、ご利用料金は完全無料です。後から料金が発生することもございません。<br>安心して求職活動を行なっていただけるよう、明瞭な運営システムで運用しております。<br class="u-desktop">地元で働きたいあなたを応援します。</p>
      </div>
      <div class="guide__item">
        <div class="guide__item-heading guideItemHeading">
          <span class="guideItemHeading__pointCircle pointCircle">
