<?php get_header(); ?>
  ...
  <section class="mainView">
    <div class="mainView__textArea">
      ...
      <h2 class="mainView__catch">プロが選ぶ、<br class="u-mobile">厳選求人が勢揃い！<br>短期から長期まで、<br>あなたにぴったりを<br>見つけます</h2>
    ...
    <div class="aboutUs__bg">
      <div class="aboutUs__inner">
        <div class="aboutUs__container">
          <h2 class="aboutUs__heading"><span>P-JOB for バイトとは？</span></h2>
          <p class="aboutUs__text">北関東の求人情報の事ならP-JOB for バイトにお任せください！幅広い業種を取り扱っています。あなたにぴったりの仕事がきっと見つかります。</p>
          <div class="aboutUs__points">
            ...
            <div class="aboutUs__point pointCard">
              ...
              <p class="pointCard__text">栃木・茨城に特化し、地域の動向をいち早くキャッチしてお届けしています。<br>P-JOB for バイトは、地元でのキャリアプランを応援します。</p>
            </div>
            <div class="aboutUs__point pointCard">
              <div class="pointCard__circle">
                <div class="pointCard__point">POINT</div>
              ...
              <p class="pointCard__text">P-JOB for バイトでは、幅広い業種に対応しています。日々たくさんの求人情報をアップデートしています。あなたに合った求人情報がきっと見つかります。</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="forCompany__container ">
          ...
          <div class="forCompany__media media">
            ...
            <div class="media__body">
                <p class="media__text">
                  P-JOB for バイトでは、北関東に特化した求人情報を提供することで、 ターゲットを絞りより高い成約率を目指しています。 <br>多様化する採用活動に対応し、一部採用フローを代行させて いただくことも可能です。<br>掲載にご興味のある方は、詳細をご確認ください。<br>一緒に地元を盛り上げましょう！
                </p>
