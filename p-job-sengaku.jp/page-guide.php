<?php get_header(); ?>
  ...
  <section class="guide inner marginTop-100-48">
    ...
    <p class="guide__lead">P-JOBは、地元で雇用を募りたい企業様と、地元で 就職されたい求職者のマッチングを実現します。<br>扱う職種やジャンルも幅広く、正社員や契約社員、派遣社員の他、パート・アルバイトとあらゆる雇用形態をカバーしています。<br class="u-mobile">地元をもっと盛り上げるべく、新社会人を応援します！</p>
