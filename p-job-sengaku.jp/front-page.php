<?php get_header(); ?>
  ...
  <section class="mainView">
    <div class="mainView__textArea">
      ...
      <h2 class="mainView__catch">故郷で見つける、<br class="u-mobile">私らしい未来。<br>地域に根ざした企業と<br>あなたの一歩を、<br>私たちが応援します</h2>
    ...
    <div class="aboutUs__bg">
      <div class="aboutUs__inner">
        <div class="aboutUs__container">
          <h2 class="aboutUs__heading"><span>P-JOB for 新卒とは？</span></h2>
          <p class="aboutUs__text" style="font-weight:bold">P-JOB for 新卒であなたにぴったりの仕事を見つけよう！</p>
          <p class="aboutUs__text"style="margin-top:1rem">P-JOB for 新卒は、北関東エリアに特化した求人サイトで、地元企業のお仕事を掲載しています。P-JOB for 新卒で理想の仕事を見つけて、社会人生活をスタートさせましょう！</p>
          <div class="aboutUs__points">
            ...
            <div class="aboutUs__point pointCard">
              ...
              <p class="pointCard__text">地元企業のリアルな情報を掲載し、職場の雰囲気や具体的な仕事内容が事前にわかるから、安心して応募できます。<br>P-JOB for 新卒は、地元就職希望の若者を全力で応援します！</p>
            </div>
            <div class="aboutUs__point pointCard">
              <div class="pointCard__circle">
                <div class="pointCard__point">POINT</div>
              ...
              <h3 class="pointCard__tittle"><span>豊富</span>な業種</h3>
              <p class="pointCard__text">「自分に合う仕事がわからない…」「未経験でも活躍できる？」そんな不安も大丈夫！P-JOB for 新卒なら、希望に合った求人が見つかります。<br>今すぐ理想の職場をチェック！</p>
            </div>
          </div>
        </div>
      </div>
