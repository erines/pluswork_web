    ...
    <div class="aboutUs__bg">
      <div class="aboutUs__inner">
        <div class="aboutUs__container">
          ...
          <p class="aboutUs__text">北関東の求人情報の事ならP-JOBにお任せください！正社員からパート・アルバイトまで多様な雇用形態と、幅広い業種を取り扱っています。あなたにぴったりの仕事がきっと見つかります。</p>
          <div class="aboutUs__points">
            ...
            <div class="aboutUs__point pointCard">
              ...
              <p class="pointCard__text">栃木・茨城に特化し、地域の動向をいち早くキャッチしてお届けしています。<br>P-JOBは、地元でのキャリアプランを応援します。</p>
            </div>
            <div class="aboutUs__point pointCard">
              <div class="pointCard__circle">
                <div class="pointCard__point">POINT</div>
              ...
              <p class="pointCard__text">P-JOBでは、幅広い業種に対応しています。日々たくさんの求人情報をアップデートしています。あなたに合った求人情報がきっと見つかります。</p>
            </div>
          </div>
        </div>
      </div>
