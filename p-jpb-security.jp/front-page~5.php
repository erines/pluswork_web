<?php get_header(); ?>
  ...
  <section class="mainView">
    <div class="mainView__textArea">
      ...
      <h2 class="mainView__catch">地元を守る誇りを、<br>あなたの仕事に。<br>地域貢献型の<br>警備員特化求人サイト</h2>
    ...
    <div class="aboutUs__bg">
      <div class="aboutUs__inner">
        <div class="aboutUs__container">
          <h2 class="aboutUs__heading"><span>P-JOB for 警備とは？</span></h2>
          <p class="aboutUs__text">P-JOB for 警備は、北関東エリアに特化した警備員専用の求人サイトで、町の安全を守るお仕事を掲載しています。P-JOB for 警備で理想の働き方を見つけましょう！</p>
          <div class="aboutUs__points">
            ...
            <div class="aboutUs__point pointCard">
              ...
              <h3 class="pointCard__tittle"><span>地域</span>に根差した仕事</h3>
              <p class="pointCard__text">警備の仕事は、地域の安全を守る大切な役割。<br>地元企業の求人を多数掲載しており、通勤しやすく馴染みのある環境で働けます。さらに、景気に左右されにくく安定した需要があるため、安心して働けるのも魅力です。</p>
            </div>
            <div class="aboutUs__point pointCard">
              <div class="pointCard__circle">
                <div class="pointCard__point">POINT</div>
              ...
              <h3 class="pointCard__tittle"><span>安心</span>な研修制度</h3>
              <p class="pointCard__text">警備の仕事が初めての方でも安心！<br>「未経験でも大丈夫？」「年齢が心配…」「週1日だけ働きたい」<br>そんなお悩みをお持ちの方も大歓迎！<br>警備の仕事が初めての方でも安心して働けるよう、業務に入る前に必ず研修を実施。必要な知識とスキルをしっかり身につけることができます。</p>
            </div>
          </div>
        </div>
      </div>
