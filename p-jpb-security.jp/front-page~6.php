        ...
        <div class="aboutUs__container">
          ...
          <div class="aboutUs__points">
            ...
            <div class="aboutUs__point pointCard">
              ...
              <h3 class="pointCard__tittle"><span>地域</span>で安心</h3>
              <p class="pointCard__text">地元企業の求人を多数掲載しており、通勤しやすく馴染みのある環境で働けます。さらに、景気に左右されにくく安定した需要があるため、安心して働けるのも魅力です。</p>
            </div>
            <div class="aboutUs__point pointCard">
              <div class="pointCard__circle">
                <div class="pointCard__point">POINT</div>
              ...
              <h3 class="pointCard__tittle"><span>研修制度</span></h3>
