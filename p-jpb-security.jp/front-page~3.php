<?php get_header(); ?>
  ...
  <section class="mainView">
    <div class="mainView__textArea">
      ...
      <h2 class="mainView__catch">地元を守る誇りを、<br>あなたの仕事に。<br class="u-mobile">あなたの仕事に。<br>地域貢献型の<br>警備員特化求人サイト</h2>
        ...
        <div class="aboutUs__container">
          ...
          <div class="aboutUs__points">
            ...
            <div class="aboutUs__point pointCard">
              ...
              <h3 class="pointCard__tittle"><span>柔軟</span>な対応</h3>
              <p class="pointCard__text">「未経験」「年齢」「週１日だけ」等...さまざまな悩みを持つ方にも安心して働いていただけるよう、P-JOB for 警備では、業務に入る前に必ず研修を実施しています。</p>
            </div>
          </div>
        </div>
      </div>
