...
<form method="get" action="<?php echo esc_url(get_post_type_archive_link("item")); ?>">
	<div class="<?php echo esc_attr($form_class); ?>">
		...
		<table border="0" cellpadding="0" cellspacing="0"><tbody>
            ...
            <tr>
				<th><img src="<?php echo get_stylesheet_directory_uri()?>/img/common/search_ctg1.gif" alt="エリアから選ぶ" /></th>
				<td>
			...
			<tr>
				<th><img src="<?php echo get_stylesheet_directory_uri()?>/img/common/search_ctg2.gif" alt="資格から選ぶ" /></th>
				<td>
            ...
            <tr>
				<th><img src="<?php echo get_stylesheet_directory_uri()?>/img/common/search_ctg3.gif" alt="施設形態から選ぶ" /></th>
				<td>
