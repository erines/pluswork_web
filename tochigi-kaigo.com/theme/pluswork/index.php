...
<div id="contents" class="right">
	...
	<map name="Map4" id="Map4">
		...
		<area shape="rect" coords="246,235,347,263" href="<?php echo add_query_arg("locs", urlencode("矢板市"), $base_url); ?>" alt="矢板市"/>
        <area shape="rect" coords="20,275,121,303" href="<?php echo add_query_arg("locs", urlencode("さくら市"), $base_url); ?>" alt="さくら市"/>
        
		<area shape="rect" coords="20,345,121,373" href="<?php echo add_query_arg("locs", urlencode("結城市"), $base_url); ?>" alt="結城市"/>
		<area shape="rect" coords="132,346,234,373" href="<?php echo add_query_arg("locs", urlencode("筑西市"), $base_url); ?>" alt="筑西市"/>
		<area shape="rect" coords="246,346,346,372" href="<?php echo add_query_arg("locs", urlencode("古河市"), $base_url); ?>" alt="古河市"/>
		<area shape="rect" coords="20,385,122,413" href="<?php echo add_query_arg("locs", urlencode("下妻市"), $base_url); ?>" alt="下妻市"/>
		<area shape="rect" coords="132,385,234,413" href="<?php echo add_query_arg("locs", urlencode("桜川市"), $base_url); ?>" alt="桜川市"/>
		<area shape="rect" coords="245,384,347,413" href="<?php echo add_query_arg("locs", urlencode("八千代町"), $base_url); ?>" alt="八千代町"/>
        ...
        <area shape="poly" coords="571,143,550,118,524,98,511,104,523,128,529,132,531,139,536,141,536,149,549,161,549,165,556,166,562,169,566,162,568,150" href="<?php echo add_query_arg("locs", urlencode("矢板市"), $base_url); ?>" alt="矢板市"/>
