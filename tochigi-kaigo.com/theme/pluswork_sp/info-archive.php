...
<div class="white_box_inner">
    ...
    <?php if($the_query->have_posts()): ?>
    	...
    	<ul>
			...
			<?php else:?>
				<img src="<?php echo get_stylesheet_directory_uri()?>/img/common/info_img_m.jpg" alt="<?php echo esc_attr(get_the_title()); ?> イメージ" class="alpha">
			<?php endif; ?>
            
				<div class="nw_data">
                	<span><?php echo date("Y.m.d", strtotime($post->post_date)); ?></span><br />
					<font><?php echo mb_strimwidth($post->post_title, 0, 30, "..."); ?></font>
                </div>
