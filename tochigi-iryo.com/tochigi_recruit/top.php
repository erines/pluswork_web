...
<?php get_header(); ?>
	<div id="main_image">
		<div class="image"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/main_image.jpg?1" alt="" /></div>
		<!--<div class="inner">
			<div class="text01 ts">
	...
	<div id="wrap">
		<div id="contents" class="cl liquid">
			<div id="main">
				<!-- メインコンテンツここから ================================================================ -->
				<?php //get_template_part( '_job_search' ); ?>
